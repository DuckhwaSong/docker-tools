...
IF "%_DOMAIN_ID2_%"=="" (
	GOTO STDIN_DOMAIN_ID2_
)
GOTO STDINPASS_DOMAIN_ID2_
:STDIN_DOMAIN_ID2_
SET /p _DOMAIN_ID2_=https접속할 도메인 앞자리(prefix-ID)를 입력하세요:
:STDINPASS_DOMAIN_ID2_
...
echo "비밀번호를 정확하게 입력한 뒤 [https://%_DOMAIN_ID2_%.%_DEV_SERVER_%]으로 접속 가능합니다."
