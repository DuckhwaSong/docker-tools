...
# > docker run --rm -itd -p 8008:80 -v "/mnt/d/work/docker/docker-tools-dhsong/alpine-skeleton/html:/www/html" --name "alpine-skeleton" "alpine-skeleton"
# > docker exec -it "alpine-skeleton" /bin/sh
